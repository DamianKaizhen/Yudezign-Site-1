...
const LinkCard = ({ link }: { link: ContentLink }) => {
  // NOT "starts with a slash". A PDF path does too, and routing it client-side
  ...
  const shell =
    'block rounded-xl border border-luxury-gray-100 bg-white p-4 shadow-luxury-sm transition-shadow hover:shadow-luxury active:scale-[0.99]';
  ...
  // A route the app can render: navigate client-side.
  if (isRoute) {
    return (
